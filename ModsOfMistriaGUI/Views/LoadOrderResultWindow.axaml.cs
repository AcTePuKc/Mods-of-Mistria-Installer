...
public partial class LoadOrderResultWindow : Window
{
    ...
    private readonly List<LoadOrderNote> _notes;
        ...
        ConflictReportActions? actions = null)
    {
        ...
        _actions = actions;
        _report = BuildReport(summary, _notes, null);
    ...
    public static Task ShowAsync(
        ...
        ConflictReportActions? actions = null)
    {
        return new LoadOrderResultWindow(summary, notes, title, showCopyButton, compact, dismissedIssues, actions)
            .ShowDialog(owner);
    }
