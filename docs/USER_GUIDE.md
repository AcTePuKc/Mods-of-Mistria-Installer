...
This guide covers installation, Nexus integration, mod list tools, localized metadata, game updates, and troubleshooting.
...
read-only preflight checks, and JSON/TOML reports. See the full [AIM CLI reference](CLI.md).
