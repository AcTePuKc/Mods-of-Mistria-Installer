...
The shipped catalog currently declares **114 hooks**, fed by **122 seams**, **3 engine fixes**, and **1 call rewrite**. The [Catalog](CATALOG.md) gives each one its own page.
