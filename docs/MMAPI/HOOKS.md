...
The shipped catalog currently declares **132 hooks**, fed by **145 seams**, **7 engine fixes**, and **1 call rewrite**. The [Catalog](CATALOG.md) gives each one its own page.
