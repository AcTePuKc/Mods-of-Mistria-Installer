...
The shipped catalog currently declares **133 hooks**, fed by **146 seams**, **7 engine fixes**, and **1 call rewrite**. The [Catalog](CATALOG.md) gives each one its own page.
