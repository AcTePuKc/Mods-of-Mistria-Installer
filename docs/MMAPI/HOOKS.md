...
The shipped catalog currently declares **138 hooks**, fed by **152 seams**, **17 engine fixes**, and **1 call rewrite**. The [Catalog](CATALOG.md) gives each one its own page.
